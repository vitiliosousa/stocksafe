...
export function NewInventoryContent() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Header */}
      <div>
        <h1 className="text-3xl font-bold text-emerald-700">Novo Inventário Cíclico</h1>
            ...
            <CardContent className="pt-6">
              ...
              <div className="space-y-2">
                <p className="flex items-center gap-2 text-sm">
                  <span className="text-green-600">✅</span> Escopo definido corretamente
                </p>
                <p className="flex items-center gap-2 text-sm">
                  <span className="text-green-600">✅</span> Responsáveis atribuídos
                </p>
                <p className="flex items-center gap-2 text-sm">
                  <span className="text-green-600">✅</span> Data futura válida
                </p>
                <p className="flex items-center gap-2 text-sm">
                  <span className="text-green-600">✅</span> Sem inventários conflitantes
                </p>
                {blockMovements && (
                  <p className="flex items-center gap-2 text-sm">
